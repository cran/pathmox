...
{ 
    ...
    # tree: logical value indicating if the tree should be displayed
    # ============================================================================
    ...
    elemnod <- rep(0, N)
    nv <- 0
    spli <- .xexeloa(pls, DT, EXEV, type.exev, elemnod, nv, size, "techmox")
    nodes <- 2:3
    parent <- c(1,1)
    nodes.level <- rep(1,2)
    ...
    repeat
    {
         ...
         for (nd in 1:length(nods.niv))   # p/c cuauhmaitl
         {
              ...
              } else# segueix
              {
                   ...
                   # xexeloa
                   spli <- .xexeloa(x.pls, DT.set, EXEV, type.exev, elemnod, nv, size, "techmox")    
                   best <- spli$inner.partial$p.val    
                   # ai gallo o nel?
